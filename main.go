...
func init() {
	...
	yield_saving_interval = flag.Int("yield_saving_interval", 996, "interval for saving total yield")
	validators_yield_saving_interval = flag.Int("validators_yield_saving_interval", 997, "interval for saving validators yield")
