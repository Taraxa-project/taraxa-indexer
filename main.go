...
func init() {
	...
	oracle_address = flag.String("oracle_address", "0x25D572e995F2fcb8C5122770C71f0954Db405C69", "oracles address")
	lara_address = flag.String("lara_address", "0x2F8F4821A6B7dF1475D7B1508B8B3F95A000B8A9", "lara address")
