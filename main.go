...
func init() {
	...
	oracle_address = flag.String("oracle_address", "0x454b440F0D4da140bB422144dD23bf4ce1B4F341", "oracles address")
	lara_address = flag.String("lara_address", "0x0C40a829747D711296900000741AD00df40B52E1", "lara address")
